...
\centerline{\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{./img/arch.png}}
...
\centerline{\includegraphics[width=272px,height=400px]{./img/websocket.png}}
